 ...
 * Contains a {@link String} for the name of the option, and a {@link RunnableSelectOption} for 
 * a callback function that runs whenever the option is selected.
 * <p>
 * The callback function will determine if the menu will close or stay open and restart via its 
 * result of {@link MenuState}
 * <p>
...
public class MenuOption {
	...
	/**
	 * Creates a {@link MenuOption} with a given string that will be shown to the user 
	 * that is representative of the option.
	 * 
	 ...
	 */
	public MenuOption onSelect(RunnableSelectOption runnable) {
	...
	public MenuOption addVisibilityCondition(RunnableCheckCondition runnable) {
		this.visibilityCondition = runnable;
		return this;
	}
